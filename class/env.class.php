...
class pro_env
{
    ...
    {/*{{{*/
        global $_G;
		$_G['siteurl'] = preg_replace("/source\/plugin\/pro/i","", $_G['siteurl']);
    ...
    {/*{{{*/
        ...
        if ($charset=='gbk') {
            $sitename = pro_utils::toutf8($sitename);
        }
        return $sitename;
    }/*}}}*/
    ...
    {/*{{{*/
        return self::get_siteurl().'/source/plugin/pro';
    }/*}}}*/
    ...
    {/*{{{*/
        if (!self::$_log_obj) {
            ...
            self::$_log_obj = new pro_log($logcfg);
        }   
